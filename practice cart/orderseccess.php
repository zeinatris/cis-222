...
$result = $pdo->query("SELECT r.*, c.Name, c.Email FROM orders as r LEFT JOIN customers as c ON c.id = r.customer_id WHERE r.id = ".$_REQUEST['id']);
    ...
    <div class="col-12">
        ...
        <div class="row col-lg-12">
            <table class="table table-hover">
                ...
                $result = $pdo->query("SELECT i.*, p.name, p.price FROM order_items as i LEFT JOIN products as p ON p.id = i.product_id WHERE i.order_id = ".$orderInfo['id']);
                if($result->num_rows > 0){
